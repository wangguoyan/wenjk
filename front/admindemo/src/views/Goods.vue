<template>
	<div>
		...
		<div style="padding: 10px 0;">
			<el-input style="width: 200px" placeholder="请输入商品名称" v-model="goodsid"></el-input>
		...
		<div style="padding: 10px 0;">
			...
			<el-upload :action="'http://' + 'localhost:8888/goods/import'" :show-file-list="false" accept="xlsx"
		...
		<el-table :data="tableData" border stripe :header-cell-class-name="headerBg"
			...
			<el-table-column prop="production" label="产量" width="120">
			</el-table-column>
